...
$customer = $customersColl->findOne(['_id' => new MongoDB\BSON\ObjectID($customerID)]);
...
<html>
   ...
   <body class="product">
      ...
      <div class="flex flex-col px-48">
         <h1 class="product_heading lg:text-7xl md:text-5xl sm:text-3xl text-3xl">Cart for <?php echo $customer['Name']; ?></h1>
            ...
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
               <div class="overflow-hidden">
                  <table
                     ...
                     <tbody>
                        <?php foreach ($customer['Product IDs'] as $productID) { ?>
                        <?php $product = $productsColl->findOne(['Product ID' => $productID]); ?>
